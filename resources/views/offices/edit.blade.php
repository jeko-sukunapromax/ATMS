                ...
                <form action="{{ route('offices.update', $office->id) }}" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-input id="name" name="name" type="text" class="block w-full bg-gray-50 border-gray-100 rounded-2xl p-4 focus:ring-indigo-500 focus:border-indigo-500 transition-all font-bold text-gray-700" value="{{ old('name', $office->name) }}" required autofocus />
                        ...
                        <div>
                            ...
                            <x-input id="acronym" name="acronym" type="text" class="block w-full bg-gray-50 border-gray-100 rounded-2xl p-4 focus:ring-indigo-500 focus:border-indigo-500 transition-all font-bold text-gray-700" value="{{ old('acronym', $office->acronym) }}" />
